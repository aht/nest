...
_lr_productions = [
  ...
  ('element -> TAG_ATTR avlist STARTI content END','element',5,'p_element_attr1','nest.py',380),
  ('element -> TAG_ATTR avlist STARTL content END','element',5,'p_element_attr1','nest.py',381),
  ('element -> TAG_ATTR avlist STARTB content END','element',5,'p_element_attr1','nest.py',382),
  ('element -> TAG_ATTR avlist STARTI END','element',4,'p_element_attr0','nest.py',395),
  ('element -> TAG_ATTR avlist STARTL END','element',4,'p_element_attr0','nest.py',396),
  ('element -> TAG_ATTR avlist STARTB END','element',4,'p_element_attr0','nest.py',397),
  ('element -> TAG STARTI content END','element',4,'p_element1','nest.py',401),
  ('element -> TAG STARTL content END','element',4,'p_element1','nest.py',402),
  ('element -> TAG STARTB content END','element',4,'p_element1','nest.py',403),
  ('element -> TAG STARTI END','element',3,'p_element0','nest.py',416),
  ('element -> TAG STARTL END','element',3,'p_element0','nest.py',417),
  ('element -> TAG STARTB END','element',3,'p_element0','nest.py',418),
  ('comment -> COMMENT STARTI content END','comment',4,'p_comment1','nest.py',422),
  ('comment -> COMMENT STARTL content END','comment',4,'p_comment1','nest.py',423),
  ('comment -> COMMENT STARTB content END','comment',4,'p_comment1','nest.py',424),
  ('comment -> COMMENT STARTI END','comment',3,'p_comment0','nest.py',428),
  ('comment -> COMMENT STARTL END','comment',3,'p_comment0','nest.py',429),
  ('comment -> COMMENT STARTB END','comment',3,'p_comment0','nest.py',430),
  ('content -> content element','content',2,'p_content11','nest.py',434),
  ('content -> content comment','content',2,'p_content11','nest.py',435),
  ('content -> content cdata','content',2,'p_content10','nest.py',440),
  ('content -> element','content',1,'p_content0','nest.py',446),
  ('content -> comment','content',1,'p_content0','nest.py',447),
  ('content -> cdata','content',1,'p_content0','nest.py',448),
  ('avlist -> avlist attrvalue','avlist',2,'p_avlist','nest.py',452),
  ('avlist -> attrvalue','avlist',1,'p_avlist0','nest.py',456),
  ('attrvalue -> ATTR_EQ value','attrvalue',2,'p_attrvalue','nest.py',460),
  ('value -> value VALUE','value',2,'p_value','nest.py',464),
  ('value -> value ESCAPED','value',2,'p_value','nest.py',465),
  ('value -> VALUE','value',1,'p_value0','nest.py',469),
  ('value -> ESCAPED','value',1,'p_value0','nest.py',470),
  ('cdata -> cdata ESCAPED','cdata',2,'p_cdata','nest.py',474),
  ('cdata -> cdata CDATA','cdata',2,'p_cdata','nest.py',475),
  ('cdata -> CDATA','cdata',1,'p_cdata0','nest.py',479),
  ('cdata -> ESCAPED','cdata',1,'p_cdata0','nest.py',480),
]
